...
class BuildingEvaluationService:
    ...
    async def get_settlement_leader(self, settlement_id: UUID) -> Optional[CharacterEntity]:
        """
    ...
    async def score_building_for_leader(
        blueprint: BuildingBlueprintEntity,
    ...
    async def get_recommended_buildings(
        ...
        settlement_id: UUID,
        limit: int = 5
    ) -> List[Tuple[BuildingBlueprintEntity, float]]:
        """
