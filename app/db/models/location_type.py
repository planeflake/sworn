...
class LocationType(Base):
    ...
    # Sub-type options for this location type (e.g., Village, Town, Capital for settlement)
    sub_types: Mapped[Optional[List[str]]] = mapped_column(
        ARRAY(String), nullable=True,
        comment="Available sub-type options for this location type."
    )
